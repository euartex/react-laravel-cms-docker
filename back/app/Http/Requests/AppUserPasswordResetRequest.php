...
class AppUserPasswordResetRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'email' => Rules::getRuleByKey('exists_app_user_email'),
        ...
        switch($routeName) {
            case 'app.user.password.reset.create':
                $rules['email'][] = 'required';
                break;
            case 'app.user.password.reset.reset':
