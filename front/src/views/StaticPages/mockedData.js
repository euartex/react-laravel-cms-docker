...
export const tableHeaderCells = [
  ...
  // { id: 3, label: "Start date", value: "start_on", isSortable: true },
  // { id: 4, label: "End date", value: "end_on", isSortable: true },
  {
    id: 5,
    label: "Description",
    value: "description",
  ...
  { id: 6, label: "Project", value: "project_id", isSortable: true },
  { id: 7, label: "Company", value: "company_id", isSortable: true },

  { id: 8, label: "Status", value: "status", isSortable: true },
  { id: 9, label: "", value: "", isSortable: false }
];
